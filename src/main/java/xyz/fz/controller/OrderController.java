...
public class OrderController {
    ...
    public String create() {
        ...
        orderService.create(System.currentTimeMillis(), random.nextInt(100), random.nextInt(10));
        return "create ok";
    }
    ...
    public String createAtTwoDs() {
        Random random = new Random(9999L);
        orderService.createAtTwoDs(System.currentTimeMillis(), random.nextInt(100), random.nextInt(10));
    ...
    public String batchCreate() {
        ...
        list.add(randomProduct());
        list.add(randomProduct());
        orderService.batchOrder(System.currentTimeMillis(), list);
